...
# -*- coding: utf-8 -*-
"""
Создаёт компанию, которая состоит из названия и персонала,
где персонал это словарь неопределённой длины – состоящий из постов и сотрудников
"""
...
def new():
    ...
    while True:
        ...
        print("\nВведите add чтобы добавить должность и работников")
